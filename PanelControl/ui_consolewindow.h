...
public:
    ...
    void setupUi(QDialog *ConsoleWindow)
    {
        ...
        ConsoleWindow->setMinimumSize(QSize(640, 480));
        ConsoleWindow->setMaximumSize(QSize(640, 480));
        ConsoleWindow->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
...
"    border: 1px sol"
                        "id #444;\n"
"}"));
        consoleText = new QPlainTextEdit(ConsoleWindow);
        consoleText->setObjectName(QStringLiteral("consoleText"));
        consoleText->setGeometry(QRect(4, 4, 633, 473));
        consoleText->viewport()->setProperty("cursor", QVariant(QCursor(Qt::IBeamCursor)));
        consoleText->setStyleSheet(QLatin1String("QToolTip\n"
"{\n"
"     border: 1px solid black;\n"
"     background-color: #ffa02f;\n"
"     padding: 1px;\n"
...
"    border: 1px sol"
                        "id #444;\n"
"}"));
        consoleText->setFrameShape(QFrame::Box);
        consoleText->setVerticalScrollBarPolicy(Qt::ScrollBarAlwaysOn);
        consoleText->setHorizontalScrollBarPolicy(Qt::ScrollBarAlwaysOff);
    ...
    {
        ConsoleWindow->setWindowTitle(QApplication::translate("ConsoleWindow", "Debug Console", 0));
    } // retranslateUi
