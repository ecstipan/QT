...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->setMinimumSize(QSize(646, 520));
        MainWindow->setMaximumSize(QSize(646, 520));
        centralWidget = new QWidget(MainWindow);
        centralWidget->setObjectName(QStringLiteral("centralWidget"));
        rawLabel = new QLabel(centralWidget);
        rawLabel->setObjectName(QStringLiteral("rawLabel"));
        rawLabel->setGeometry(QRect(4, 4, 640, 480));
        rawLabel->setMinimumSize(QSize(640, 480));
        rawLabel->setMaximumSize(QSize(640, 480));
